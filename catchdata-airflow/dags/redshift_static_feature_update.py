...
from airflow.providers.common.sql.operators.sql import SQLExecuteQueryOperator # 테이블 생성용

from sqlalchemy.types import JSON 
from sqlalchemy import text 
from sqlalchemy import Numeric, SmallInteger

import pandas.api.types as pd_types # 데이터 타입 정의를 위해 명시적으로 사용
...
RAW_TABLE = f"raw_data.kakao_crawl"
